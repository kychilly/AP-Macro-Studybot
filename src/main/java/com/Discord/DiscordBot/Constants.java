...
public class Constants {
    ...
    public static String slashPrefix = "macro"; // Yea you have to put a / before this everytime
    ...
    public static int percentageFor3 = 53; // The percent you need to score a 3 or higher on the AP test
    ...
    public static int[] scorePercents = {81, 63, 53, 42}; // The percents to score a 5, 4, 3, and 2
    ...
    public static String APPicture = "https://media.discordapp.net/attachments/1186115783013711894/1406153244165537906/Z.png?ex=68a16dc2&is=68a01c42&hm=b4389581a714a035af9f594c9670cd5b648f3a71ad0d27cb00612edcb596c2d6&=&format=webp&quality=lossless&width=225&height=126";

    // To invite the bot to your server
    public static String botInviteLink = "https://discord.com/oauth2/authorize?client_id=1406150698818736179&permissions=2147503104&integration_type=0&scope=bot";

    // Bot mention
    public static String botMention = "<@1406150698818736179>";
    ...
    public static MessageEmbed createResourcesEmbed() {
        EmbedBuilder embed = new EmbedBuilder()
                ...
                .setDescription("Here are some valuable resources to help you succeed in AP Macroeconomics:")
                .setColor(0x3498db)
                .setThumbnail(Constants.collegeBoardThumbnail)

                // Official College Board Resources
                .addField("🎓 Official College Board Resources",
                        "• [Course Overview](https://apstudents.collegeboard.org/courses/ap-macroeconomics)\n" +
                                "• [Course Description](https://apcentral.collegeboard.org/pdf/ap-macroeconomics-course-and-exam-description.pdf)\n" +
                                "• [Past Exam Questions](https://apcentral.collegeboard.org/courses/ap-macroeconomics/exam)\n" +
                                "• [AP Classroom](https://myap.collegeboard.org/) (Requires teacher login)", false)

                // Video Tutorials
                .addField("📺 Video Tutorials",
                        "• [College Board AP Macroeconomics Playlist](https://www.youtube.com/playlist?list=PLoGgviqq4846V9T0iNbaQJ7s94p5gQ_sL)\n" +
                                "• [Khan Academy AP Macroeconomics](https://www.khanacademy.org/economics-finance-domain/ap-macroeconomics)\n" +
                                "• [ACDC Leadership YouTube](https://www.youtube.com/user/ACDCLeadership)", false)

                // Practice & Study Sites
                .addField("📖 Practice & Study Sites",
                        "• [Fiveable AP Macro Resources](https://library.fiveable.me/ap-macro)\n" +
                                "• [Albert.io AP Macroeconomics Practice](https://www.albert.io/ap-macroeconomics)\n" +
                                "• [Quizlet Flashcards](https://quizlet.com/subject/ap-macroeconomics/)", false)

                // Additional Help
                .addField("🆘 Additional Help",
                        "• [Investopedia Economics Articles](https://www.investopedia.com/economics-4689741)\n" +
                                "• [Council for Economic Education](https://www.councilforeconed.org/)\n" +
                                "• [Reddit r/APStudents](https://www.reddit.com/r/APStudents/)", false)
    ...
    public static void SendAvailableQuestions(MessageReceivedEvent event) {
        ...
        embed.addField("**Unit 1: Basic Economic Concepts**",
                String.format(
                        "🔹 **%d questions**\nCovers scarcity, opportunity cost, production possibilities, comparative advantage, and gains from trade.\n\u200B",
                        Unit1.numUnit1Questions),
                false);

        embed.addField("**Unit 2: Economic Indicators and the Business Cycle**",
                String.format(
                        "🔹 **%d questions**\nFocuses on GDP, inflation, unemployment, price indices, and phases of the business cycle.\n\u200B",
                        Unit2.numUnit2Questions),
                false);

        embed.addField("**Unit 3: National Income and Price Determination**",
                String.format(
                        "🔹 **%d questions**\nIncludes aggregate demand, aggregate supply, equilibrium, and multiplier effects.\n\u200B",
                        Unit3.numUnit3Questions),
                false);

        embed.addField("**Unit 4: Financial Sector**",
                String.format(
                        "🔹 **%d questions**\nCovers money, banking, the loanable funds market, and monetary policy.\n\u200B",
                        Unit4.numUnit4Questions),
                false);

        embed.addField("**Unit 5: Long-Run Consequences of Stabilization Policies**",
                String.format(
                        "🔹 **%d questions**\nFocuses on economic growth, fiscal policy, monetary policy, Phillips curve, and crowding out.\n\u200B",
                        Unit5.numUnit5Questions),
                false);

        embed.addField("**Unit 6: Open Economy – International Trade and Finance**",
                String.format(
                        "🔹 **%d questions**\nIncludes balance of payments, foreign exchange markets, and trade policies.\n\n" +
